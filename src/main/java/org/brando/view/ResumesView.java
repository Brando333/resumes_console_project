...
public class ResumesView {
    ...
    public static void showResumesEdit(Resume resume, User user) {
        ...
        switch (field) {
            case "title", "1" -> {
                ...
                resumeController.updateTittle(value);
            ...
            case "full name", "2" -> {
                ...
                resumeController.updateFullName(value);
            ...
            case "home address", "3" -> {
                ...
                value = scanner.nextLine();
                resumeController.updateAddress(value);
            ...
            case "description", "4" -> {
                ...
                value = scanner.nextLine();
                resumeController.updateDescription(value);
    ...
    public static void showResumesCreate(User user) {
        ...
        try {
            ...
            int idResume = resumeController.getResume().getId();
            resume.setId(idResume);
